...
<span className="text-xl font-bold text-gray-900 dark:text-slate-100 tracking-tight hidden sm:inline">Third Eye</span>
          </Link>
          ...
          <div>
            ...
            {!loading && results && (
              <p className="text-sm text-gray-400 dark:text-slate-500 mt-0.5">
                <span className="font-semibold text-gray-600 dark:text-slate-300">{results.total}</span> produto{results.total !== 1 ? 's' : ''} ·{' '}
                <span className="font-semibold text-gray-600 dark:text-slate-300">{totalOffers}</span> oferta{totalOffers !== 1 ? 's' : ''}
              </p>
            )}
          </div>
